...
type BoolSeg = { t: 'bool'; k: string; def: string; desc?: string }
type NumSeg = { t: 'num'; k: string; def: string; w?: number; min?: number; max?: number; step?: number; odd?: boolean; opts?: string[]; desc?: string }

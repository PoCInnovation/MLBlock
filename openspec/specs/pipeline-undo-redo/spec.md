...
L'éditeur de pipeline maintient un historique d'annulation/rétablissement des gestes d'édition (nœuds, arêtes, paramètres, nom du projet) via des boutons et des raccourcis clavier. L'état de sauvegarde (`isDirty`) se recalcule naturellement après chaque undo/redo.

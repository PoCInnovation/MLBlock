# Block Param Intelligence

## Purpose

Aide à la saisie des hyperparamètres : métadonnées extraites des docstrings (fourchettes, parité, choix, formats), segments UI assistés avec validation live, et autocomplétion dataflow-aware de `target_column`.

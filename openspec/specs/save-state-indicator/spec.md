...
Le bouton « Sauvegarder » de l'éditeur reflète l'état de synchronisation du pipeline : désactivé avec un retour visuel « Sauvegardé » quand il n'y a rien à sauvegarder, actif dès qu'une modification non sauvegardée existe. Le changement est purement indicatif — la logique de save, stash et restauration reste inchangée.
